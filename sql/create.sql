...
INSERT INTO DB2024_Review VALUES
    (1, 's2eojeong', 1, 5, '육회덮밥 너무 고소하고 맛있어용!!'),
    (2, 'cannes7', 2, 4, '소고기 가지덮밥 맛있긴한데 약간 비싸요ㅠㅠ'),
    (3, 'meanwest', 1, 5, '여기 육회덮밥 진짜 너무 맛있어요.. 모미지 절대 지켜.'),
    (4, 'chacha091', 1, 5, '사케동 정말 신선하고 맛있어요!'),
    (5, 'astralfinance', 2, 5, '간장새우계란밥이 진짜 최고에요.. 눈물 훌리면서 먹었어요'),
    (6, 'cannes7', 1, 4, '가격대가 좀 있긴해도 양이 많아서 먹고나면 배불러요ㅎㅎ'),
    (7, 's2eojeong', 3, 0, '스모크드 베이컨 할리피뇨 바게트 매콤하긴한데 맛있게 잘 먹었어요 추천!!'),
    (8, 'meanwest', 1, 4, '잠봉뵈르 독특하고 맛있어요!'),
    (9, 'astralfinance', 1, 3, '그냥 잠봉뵈르에요. 무난합니다.'),
    (10, 'meanwest', 2, 5, '홍새우 파스타 바다 향 솔솔나고 맛있어요!'),
    (11, 'chacha091', 4, 4, 'E.C.C 샐러드 완전 신선하고 무난하게 맛있어요!'),
    (12, 's2eojeong', 2, 3, '홍새우 처음 먹어보는데 나쁘지 않아요.'),
    (13, 'meanwest', 3, 5, '리코타치즈 들어간 샌드위치 꼭 드세요. 신세계입니다'),
    (14, 'cannes7', 2, 5, '생연어 신선하고 촉촉하고 부드러워요ㅠㅠ 추천!!'),
    (15, 'chacha091', 2, 0, '정말 불곰이 반할만하네요.'),
    (16, 'astralfinance', 1, 4, '등심돈까스 무난하게 맛있어요~'),
    (17, 'cannes7', 2, 5, '등심보다 부드러워서 먹기 좋아요.'),
    (18, 'meanwest', 2, 3, '튀김 옷이 약간 눅눅하네요ㅠㅠ'),
    (19, 'astralfinance', 1, 5, '붓가케 진짜 맛있어요… 꼭 드셔보세요 다들!'),
    (20, 'cannes7', 2, 4, '기츠네 처음 들어보는데 맛있고 사장님이 친절하세요.'),
    (21, 'meanwest', 3, 5, '가케를 시켜보았는데 역시 이 집은 다 맛있네요!'),
    (22, 'chacha091', 1, 5, '아콘스톨김밥만큼 가성비도 좋고 맛있는 곳은 없어요.. 학부생들에게 한줄기의 빛.'),
    (23, 'cannes7', 2, 5, '가끔 분식 땡길때 순대떡볶음 먹는데 여전히 맛있네요.'),
    (24, 'meanwest', 1, 4, '바빠서 시간 없을때 간단하게 먹기 좋네요.'),
    (25, 'chacha091', 1, 5, '사케동 위에 연어 너무 신선하고 부드러워요!'),
    (26, 's2eojeong', 1, 4, '학교 주변에 사케동 파는 곳 많은데 여기도 나쁘지 않은 것 같아요.'),
    (27, 'chacha091', 2, 5, '아부리사케동도 맛있네요. 불향이 베어져서 좋아요.'),
    (28, 'cannes7', 2, 3, '연어가 너무 구워져서 안 촉촉했어요ㅠㅠ'),
    (29, 'chacha091', 1, 5, '비오는 날 마다 삼겹샤브 먹으러 오는데 참 맛있네요.'),
    (30, 'astralfinance', 2, 5, '버섯 샤브세트 삼겹샤브만큼 맛있어요! '),
    (31, 'meanwest', 1, 4, '제육덮밥 무난하게 맛있어요.'),
    (32, 'chacha091', 3, 3, '튀김이 안 바삭거려서 아쉬워요..'),
    (33, 's2eojeong', 1, 4, '양이 약간 적긴해도 나쁘지 않네요.'),
    (34, 'meanwest', 2, 5, '평소에도 자주 먹었는데 오늘은 특으로 시켰어요! '),
    (35, 'chacha091', 1, 4, '생소한 이름인데 이국적인 맛이 나서 특이해요.'),
    (36, 'astralfinance', 2, 5, '타코 비슷한 맛도 나는 것 같아요. 나쁘지않아요!'),
    (37, 'chacha091', 1, 3, '고기냄새가 약간 나는 것 같아요..'),
    (38, 'cannes7', 1, 5, '위에 노른자 톡 터뜨려서 먹으면 맛있어요!'),
    (39, 's2eojeong', 2, 5, '둘이 먹다 하나 죽어도 모를 맛이에요.. 강추'),
    (40, 'cannes7', 2, 4, '싱싱하니 맛있네요.'),
    (41, 's2eojeong', 1, 5, '잠시동안 베트남에 있다왔네요.'),
    (42, 'cannes7', 1, 4, '국물이 깔끔하고 좋아요.'),
    (43, 'meanwest', 2, 3, '고기가 좀 퍽퍽해요.. 가격에 비해 고기양이 적은것도 같네요.'),
    (44, 'chacha091', 1, 4, '한식 땡길 때 먹으면 좋아요.'),
    (45, 'astralfinance', 2, 3, '아무래도 소불고기가 가격대가 좀 있어요.. 맛있긴한데 아쉽 ㅠㅠ'),
    (46, 'meanwest', 1, 4, '크림이면 보통 꾸덕하기 마련인데 이건 매콤해서 느끼하지도 않고 좋아요. 강추!!'),
    (47, 'cannes7', 1, 5, '너무 맛있어요!!!! 단짠단짠의 대명사.'),
    (48, 's2eojeong', 2, 5, '파스타 중에서 오일 파스타를 제일 좋아하는데 맛있네요 ㅎㅎ'),
    (49, 'cannes7', 2, 4, '아침에 브런치로 먹으니까 맛있고 적당히 배부르네요.'),
    (50, 'meanwest', 1, 4, '건강한 맛이라 간은 약하지만 그래도 먹을만해요. '),
    (51, 'cannes7', 1, 4, 'msg 하나 없이 자연친화적인 맛이에요. 속세를 벗어나고 싶으신 분들께 추천드려요.'),
    (52, 's2eojeong', 2, 3, '나물이 약간 질겨서 씹는데 불편했어요ㅠㅠ'),
    (53, 'meanwest', 1, 4, '엄마가 해주는 찌개 맛 나요. 얼른 종강했으면'),
    (54, 'cannes7', 2, 4, '집에서 해먹는 볶음밥 맛이에요. 나쁘지 않아요.'),
    (55, 'meanwest', 1, 5, '나쁘진 않았는데 다음엔 안 시킬 것 같아요..!'),
    (56, 'chacha091', 2, 5, '여기 소스가 진짜 특이하고 맛있어요!!'),
    (57, 'astralfinance', 2, 4, '꾸덕하니 맛있네요!!'),
    (58, 'meanwest', 1, 4, '가지 껍질이 약간 질기긴 했지만 소스가 맛있어서 괜찮았어요!!'),
    (59, 'chacha091', 1, 4, '소스가 특이한데 묘하게 중독성 있어요..'),
    (60, 'cannes7', 2, 4, '평소에 미역국 되게 좋아하는데 들깨 미역국이래서 시켜보았어요. 나쁘진 않지만 역시 그냥 미역국이 더 나은 것 같아요.'),
    (61, 'meanwest', 2, 5, '국물이 꾸-덕하고 고소해요. 간만에 맛있게 식사했어요.'),
    (62, 'astralfinance', 1, 3, '양념이 너무 달아요ㅠㅠ');
